...
func main() {
	...
	app.RegisterModule(mnet.GetSambaModule())
	app.RegisterModule(mfiles.GetModule())
	app.RegisterModule(mmpd.GetModule())
	app.RegisterModule(mnotepad.GetModule())
	app.RegisterModule(msystem.GetModule())
	app.RegisterModule(msystother.GetModule())
	app.RegisterModule(msysproc.GetModule())
	app.RegisterModule(msyslogs.GetModule())
	app.RegisterModule(msysusers.GetModule())
	app.RegisterModule(mstorage.GetModule())
	app.RegisterModule(msmart.GetModule())
	app.RegisterModule(mutls.GetModule())
